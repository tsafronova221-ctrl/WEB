...
class Lab(db.Model):
    ...
    timer_duration = db.Column(db.Integer, default=0)  # Время на выполнение в минутах (0 = без ограничений)
...
class Attempt(db.Model):
    ...
    violations = db.Column(db.Text)  # JSON строка с нарушениями (список событий)
